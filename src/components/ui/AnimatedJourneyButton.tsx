...
interface AnimatedJourneyButtonProps {
  onClick?: () => void;
  href?: string;
  children?: React.ReactNode;
}

const AnimatedJourneyButton: React.FC<AnimatedJourneyButtonProps> = ({ 
  onClick, 
  href,
  ...
  const iconsSVG = (
    <>
      <div className="icon-1">
        <svg xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 26.3 65.33" style={{shapeRendering: 'geometricPrecision' as const, textRendering: 'geometricPrecision' as const, fillRule: 'evenodd' as const, clipRule: 'evenodd' as const}} version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
          <g id="Layer_x0020_1">
      ...
      <div className="icon-2">
        <svg xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 11.67 37.63" style={{shapeRendering: 'geometricPrecision' as const, textRendering: 'geometricPrecision' as const, fillRule: 'evenodd' as const, clipRule: 'evenodd' as const}} version="1.1" xmlSpace="preserve" xmlns="http://www.w3.org/2000/svg">
          <g id="Layer_x0020_1">
...
const StyledWrapper = styled.div`
  ...
  button:hover .icon-1, a:hover .icon-1 {
  ...
  button:hover .icon-2, a:hover .icon-2 {
  ...
  button:hover .icon-3, a:hover .icon-3 {
