      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <button
            ...
            className="px-6 md:px-8 py-2.5 md:py-3 border border-gray-900 dark:border-gray-300 text-gray-900 dark:text-gray-300 text-sm md:text-base hover:bg-gray-900 dark:hover:bg-gray-300 hover:text-white dark:hover:text-gray-900 transition-all duration-300">
            Let's Work Together
          </button>
        </motion.div>
      </div>
